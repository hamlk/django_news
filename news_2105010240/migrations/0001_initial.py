# Generated by Django 3.2 on 2022-12-27 11:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article', to='news_2105010240.article')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('select_article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='select_article', to='news_2105010240.article')),
            ],
        ),
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cate', to='news_2105010240.category'),
        ),
    ]
